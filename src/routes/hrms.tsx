...
import { ShieldCheck, Users, UserCog, User, Check, X, ChevronRight } from "lucide-react";
...
function HrmsPage() {
  ...
  const grouped = useMemo(() => ({
    admin: EMPLOYEES.filter((e) => e.appRole === "admin"),
    manager: EMPLOYEES.filter((e) => e.appRole === "manager"),
    employee: EMPLOYEES.filter((e) => e.appRole === "employee"),
  }), []);
